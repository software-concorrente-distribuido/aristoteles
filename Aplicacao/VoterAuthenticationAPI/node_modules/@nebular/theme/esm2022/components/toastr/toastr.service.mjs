...
export class NbToastrContainerRegistry {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.1.0", ngImport: i0, type: NbToastrContainerRegistry, deps: [{ token: i1.NbOverlayService }, { token: i2.NbPositionBuilderService }, { token: i3.NbPositionHelper }, { token: i0.ComponentFactoryResolver }, { token: NB_DOCUMENT }], target: i0.ɵɵFactoryTarget.Injectable }); }
    static { this.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "17.1.0", ngImport: i0, type: NbToastrContainerRegistry }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "17.1.0", ngImport: i0, type: NbToastrContainerRegistry, decorators: [{
            type: Injectable
        }], ctorParameters: () => [{ type: i1.NbOverlayService }, { type: i2.NbPositionBuilderService }, { type: i3.NbPositionHelper }, { type: i0.ComponentFactoryResolver }, { type: undefined, decorators: [{
                    type: Inject,
                    args: [NB_DOCUMENT]
                }] }] });
/**
