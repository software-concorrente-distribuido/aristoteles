...
export class NbChatMessageComponent {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.1.0", ngImport: i0, type: NbChatMessageComponent, deps: [{ token: i1.DomSanitizer }, { token: i2.NbChatCustomMessageService }], target: i0.ɵɵFactoryTarget.Component }); }
    static { this.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "17.1.0", type: NbChatMessageComponent, selector: "nb-chat-message", inputs: { reply: "reply", message: "message", sender: "sender", date: "date", dateFormat: "dateFormat", files: "files", quote: "quote", latitude: "latitude", longitude: "longitude", avatar: "avatar", type: "type", customMessageData: "customMessageData" }, host: { properties: { "@flyInOut": "this.flyInOut", "class.not-reply": "this.notReply", "class.reply": "this.reply" } }, ngImport: i0, template: `
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "17.1.0", ngImport: i0, type: NbChatMessageComponent, decorators: [{
            type: Component,
            args: [{
  ...
  `,
        ...
        }], ctorParameters: () => [{ type: i1.DomSanitizer }, { type: i2.NbChatCustomMessageService }], propDecorators: { flyInOut: [{
                type: HostBinding,
                args: ['@flyInOut']
            }], notReply: [{
                type: HostBinding,
