...
export class NbFlipCardComponent {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.1.0", ngImport: i0, type: NbFlipCardComponent, deps: [], target: i0.ɵɵFactoryTarget.Component }); }
    static { this.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "17.1.0", type: NbFlipCardComponent, selector: "nb-flip-card", inputs: { flipped: "flipped", showToggleButton: "showToggleButton" }, host: { properties: { "class.flipped": "this.flipped" } }, ngImport: i0, template: `
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "17.1.0", ngImport: i0, type: NbFlipCardComponent, decorators: [{
            type: Component,
