...
export class NbAlertComponent {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.1.0", ngImport: i0, type: NbAlertComponent, deps: [{ token: i1.NbStatusService }], target: i0.ɵɵFactoryTarget.Component }); }
    static { this.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "17.1.0", type: NbAlertComponent, selector: "nb-alert", inputs: { size: "size", status: "status", accent: "accent", outline: "outline", closable: "closable" }, outputs: { close: "close" }, host: { properties: { "class.closable": "this.closable", "class.size-tiny": "this.tiny", "class.size-small": "this.small", "class.size-medium": "this.medium", "class.size-large": "this.large", "class.size-giant": "this.giant", "class.status-primary": "this.primary", "class.status-success": "this.success", "class.status-info": "this.info", "class.status-warning": "this.warning", "class.status-danger": "this.danger", "class.status-basic": "this.basic", "class.status-control": "this.control", "class.accent-primary": "this.primaryAccent", "class.accent-success": "this.successAccent", "class.accent-info": "this.infoAccent", "class.accent-warning": "this.warningAccent", "class.accent-danger": "this.dangerAccent", "class.accent-basic": "this.basicAccent", "class.accent-control": "this.controlAccent", "class.outline-primary": "this.primaryOutline", "class.outline-success": "this.successOutline", "class.outline-info": "this.infoOutline", "class.outline-warning": "this.warningOutline", "class.outline-danger": "this.dangerOutline", "class.outline-basic": "this.basicOutline", "class.outline-control": "this.controlOutline", "class": "this.additionalClasses" } }, ngImport: i0, template: `
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "17.1.0", ngImport: i0, type: NbAlertComponent, decorators: [{
            type: Component,
